...
public class TelaPrincipal extends JFrame  implements ActionListener 
{
   ...
   JLabel grafico = new JLabel(imagem);
      ...
      public TelaPrincipal()
      {
         ...
         setLayout(null); // deixei 'null' para definir cada um na mão, mas poderia definir um local padrão aqui
         
        grafico.setBounds(272, 85, 64, 64);
        add(grafico);
         
         taxas.setBounds(138, 170, 110, 35); // Localização do titulo "taxas" pensanso em grafico: 138 seria na linha x, 170 na linha y. 110 largura do titulo e 35 a altura
